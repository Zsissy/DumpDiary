...
import com.dumpdiary.app.ui.DiaryViewModel;
...
public final class DaggerDumpDiaryApplication_HiltComponents_SingletonC {
  private DaggerDumpDiaryApplication_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public DumpDiaryApplication_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements DumpDiaryApplication_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public DumpDiaryApplication_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements DumpDiaryApplication_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DumpDiaryApplication_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements DumpDiaryApplication_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DumpDiaryApplication_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements DumpDiaryApplication_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DumpDiaryApplication_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements DumpDiaryApplication_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DumpDiaryApplication_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements DumpDiaryApplication_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DumpDiaryApplication_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements DumpDiaryApplication_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DumpDiaryApplication_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends DumpDiaryApplication_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends DumpDiaryApplication_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends DumpDiaryApplication_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends DumpDiaryApplication_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(4).put(LazyClassKeyProvider.com_dumpdiary_app_ui_AuthViewModel, AuthViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_dumpdiary_app_ui_DiaryViewModel, DiaryViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_dumpdiary_app_ui_MainViewModel, MainViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_dumpdiary_app_ui_SettingsViewModel, SettingsViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends DumpDiaryApplication_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(4).put(LazyClassKeyProvider.com_dumpdiary_app_ui_AuthViewModel, ((Provider) authViewModelProvider)).put(LazyClassKeyProvider.com_dumpdiary_app_ui_DiaryViewModel, ((Provider) diaryViewModelProvider)).put(LazyClassKeyProvider.com_dumpdiary_app_ui_MainViewModel, ((Provider) mainViewModelProvider)).put(LazyClassKeyProvider.com_dumpdiary_app_ui_SettingsViewModel, ((Provider) settingsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.dumpdiary.app.ui.MainViewModel 
  ...
  private static final class ActivityRetainedCImpl extends DumpDiaryApplication_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends DumpDiaryApplication_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends DumpDiaryApplication_HiltComponents.SingletonC {
    ...
    private LogDao logDao() {
      return AppModule_ProvideLogDaoFactory.provideLogDao(provideDatabaseProvider.get());
    }
    ...
    @Override
    public void injectDumpDiaryApplication(DumpDiaryApplication dumpDiaryApplication) {
      injectDumpDiaryApplication2(dumpDiaryApplication);
    }
    ...
    private DumpDiaryApplication injectDumpDiaryApplication2(DumpDiaryApplication instance) {
      DumpDiaryApplication_MembersInjector.injectWorkerFactory(instance, hiltWorkerFactory());
      return instance;
    }
